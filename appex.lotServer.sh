...
URLKernel='https://raw.githubusercontent.com/9sr/serverSpeeder_kernel/master/serverSpeeder.txt'
...
wget --no-check-certificate -q -O "/root/appex/apxfiles/bin/acce-"$KNV"-["$KNA"_"$KNN"_"$KNK"]" "https://raw.githubusercontent.com/9sr/serverSpeeder_kernel/master/$MyKernel"
...
{
[ ! -f /root/appex.zip ] && wget --no-check-certificate -q -O "/root/appex.zip" "https://raw.githubusercontent.com/9sr/serverSpeeser_Install/master/appex.zip"
